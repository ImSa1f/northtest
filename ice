...
if UseUi then
    ...
    if getfenv().getconnections then
        for _, skib in next, getfenv().getconnections(cloneref(game:GetService("ScriptContext")).Error) do
            skib:Disable()
        end
    end

    local BASE_WIDTH, BASE_HEIGHT = 1920, 1080
    local scale = 1
    ...
    local function calculateScale()
        ...
        if currentCamera then
            ...
            local scalingFactor = getgenv().Scaling or 1
            return math.min(screenSize.X / BASE_WIDTH, screenSize.Y / BASE_HEIGHT) * scalingFactor
        end
        return 1 
    end
    ...
    local function MakeResizable(frame)
        ...
        ResizeHandle.Size = UDim2.new(0.5, 0, 0, 2)
        ResizeHandle.Position = UDim2.new(0.5, 0, 1, -3)
        ...
        game:GetService("UserInputService").InputChanged:Connect(function(input)
            if resizing and input.UserInputType == Enum.UserInputType.MouseMovement then
                ...
                frame.Size = UDim2.new(
                    startSize.X.Scale, startSize.X.Offset,
                    0, math.max(300, startSize.Y.Offset + deltaY)
                )
            end
        end)
    end
    ...
    function MacLib:Window(Settings)
        ...
        local acrylicBlur = Settings.AcrylicBlur ~= nil and Settings.AcrylicBlur or true
        ...
        base.Size = Settings.Size or UDim2.new(0, 868 * scale, 0, 650 * scale)
        ...
        sidebar.Size = UDim2.new(0.250, 0, 1, 0) 
        sidebar.Parent = base
        ...
        local function applyState(button, enabled)
            ...
            button.Size = UDim2.new(size.X.Scale, size.X.Offset * scale, size.Y.Scale, size.Y.Offset * scale)
            ...
            if not enabled then
                ...
                newStroke.Transparency = transparency
        ...
        divider1.Size = UDim2.new(1, 0, 0, 1 * scale)
        ...
        information.Position = UDim2.fromOffset(0, 31 * scale)
        information.Size = UDim2.new(1, 0, 0, 60 * scale)
        ...
        divider2.Size = UDim2.new(1, 0, 0, 1 * scale)
        ...
        informationHolderUIPadding.PaddingBottom = UDim.new(0, 10 * scale)
        informationHolderUIPadding.PaddingLeft = UDim.new(0, 23 * scale)
        informationHolderUIPadding.PaddingRight = UDim.new(0, 22 * scale)
        informationHolderUIPadding.PaddingTop = UDim.new(0, 10 * scale)
        ...
        globalSettingsButton.Size = UDim2.fromOffset(16 * scale, 16 * scale)
        ...
        title.Size = UDim2.new(1, -20 * scale, 0, 0)
        ...
        sidebarGroup.Position = UDim2.fromOffset(0, 91 * scale)
        sidebarGroup.Size = UDim2.new(1, 0, 1, -91 * scale)
        ...
        userInfo.Size = UDim2.new(1, 0, 0, 107 * scale)
        ...
        informationGroupUIPadding.PaddingBottom = UDim.new(0, 17 * scale)
        informationGroupUIPadding.PaddingLeft = UDim.new(0, 25 * scale)
        ...
        informationGroupUIListLayout.Padding = UDim.new(0, 2 * scale)
        ...
        headshot.Size = UDim2.fromOffset(32 * scale, 32 * scale)
        ...
        userAndDisplayFrame.Size = UDim2.new(1, -42 * scale, 0, 32 * scale)
        ...
        userAndDisplayFrameUIPadding.PaddingLeft = UDim.new(0, 8 * scale)
        userAndDisplayFrameUIPadding.PaddingTop = UDim.new(0, 3 * scale)
        ...
        userAndDisplayFrameUIListLayout.Padding = UDim.new(0, 1 * scale)
        ...
        topbar.Size = UDim2.new(1, 0, 0, 63 * scale)
        ...
        divider4.Size = UDim2.new(1, 0, 0, 1 * scale)
        ...
        uIPadding2.PaddingLeft = UDim.new(0, 20 * scale)
        uIPadding2.PaddingRight = UDim.new(0, 20 * scale)
        ...
        moveIcon.Size = UDim2.fromOffset(15 * scale, 15 * scale)
        ...
        interact.Size = UDim2.fromOffset(40 * scale, 40 * scale)
        ...
        function WindowFunctions:TabGroup()
            ...
            divider3.Size = UDim2.new(1, -21 * scale, 0, 1 * scale)
            ...
            uIListLayout1.Padding = UDim.new(0, 15 * scale)
            ...
            uIPadding1.PaddingBottom = UDim.new(0, 15 * scale)
            ...
            function SectionFunctions:Tab(Settings)
                ...
                tabSwitcher.Position = UDim2.new(0.5, 0, 0, 0 * scale) 
                tabSwitcher.Size = UDim2.new(0.9, 0, 0, 50 * scale) 
            
                local uiScale = Instance.new("UIScale")
                uiScale.Parent = tabSwitcher
                ...
                tabSwitcherName.TextSize = 16 * scale
                ...
                tabSwitcherUIPadding.PaddingLeft = UDim.new(0, 24 * scale)
                tabSwitcherUIPadding.PaddingRight = UDim.new(0, 35 * scale)
                tabSwitcherUIPadding.PaddingTop = UDim.new(0, 1 * scale)
                ...
                elements1.Position = UDim2.fromOffset(0, 63 * scale)
                elements1.Size = UDim2.new(1, 0, 1, -63 * scale)
                elements1.ClipsDescendants = true

                local elementsUIPadding = Instance.new("UIPadding")
                elementsUIPadding.Name = "ElementsUIPadding"
                elementsUIPadding.PaddingRight = UDim.new(0, 5 * scale)
                elementsUIPadding.PaddingTop = UDim.new(0, 10 * scale)
                elementsUIPadding.PaddingBottom = UDim.new(0, 10 * scale)
                ...
                elementsScrollingUIPadding.PaddingBottom = UDim.new(0, 5 * scale)
                elementsScrollingUIPadding.PaddingLeft = UDim.new(0, 11 * scale)
                elementsScrollingUIPadding.PaddingRight = UDim.new(0, 3 * scale)
                elementsScrollingUIPadding.PaddingTop = UDim.new(0, 5 * scale)
                ...
                elementsScrollingUIListLayout.Padding = UDim.new(0, 15 * scale)
                ...
                function TabFunctions:Section(Settings)
                    ...
                    sectionUIListLayout.Padding = UDim.new(0, 10 * scale) 
                    ...
                    sectionUIPadding.PaddingBottom = UDim.new(0, 20 * scale) 
                    sectionUIPadding.PaddingLeft = UDim.new(0, 20 * scale)   
                    sectionUIPadding.PaddingRight = UDim.new(0, 18 * scale)
                    sectionUIPadding.PaddingTop = UDim.new(0, 22 * scale)  
                    ...
                    function SectionFunctions:Button(Settings, Flag)
                        ...
                        button.Size = UDim2.new(1, 0, 0, 38 * scale)
                        ...
                        buttonImage.Size = UDim2.fromOffset(15 * scale, 15 * scale)
                    ...
                    function SectionFunctions:Toggle(Settings, Flag)
                        ...
                        toggle.Size = UDim2.new(1, 0, 0, 38 * scale)
                        ...
                        toggleName.Size = UDim2.new(1, -50 * scale, 0, 0)
                        ...
                        toggle1.Size = UDim2.fromOffset(41 * scale, 21 * scale)
                        toggle1.ImageTransparency = 0.5

                        local toggleUIPadding = Instance.new("UIPadding")
                        toggleUIPadding.Name = "ToggleUIPadding"
                        toggleUIPadding.PaddingBottom = UDim.new(0, 1 * scale)
                        toggleUIPadding.PaddingLeft = UDim.new(0, -2 * scale)
                        toggleUIPadding.PaddingRight = UDim.new(0, 3 * scale)
                        toggleUIPadding.PaddingTop = UDim.new(0, 1 * scale)
                        ...
                        togglerHead.Size = UDim2.fromOffset(15 * scale, 15 * scale)
                    ...
                    function SectionFunctions:Slider(Settings, Flag)
                        ...
                        slider.Size = UDim2.new(1, 0, 0, 38 * scale)
                        ...
                        sliderValue.Size = UDim2.fromOffset(41 * scale, 21 * scale)
                        ...
                        sliderValueUIPadding.PaddingLeft = UDim.new(0, 2 * scale)
                        sliderValueUIPadding.PaddingRight = UDim.new(0, 2 * scale)
                        ...
                        sliderElementsUIListLayout.Padding = UDim.new(0, 20 * scale)
                        ...
                        sliderBar.Size = UDim2.fromOffset(123 * scale, 3 * scale)
                        ...
                        sliderHead.Size = UDim2.fromOffset(12 * scale, 12 * scale)
                        sliderHead.ZIndex = sliderValue.ZIndex - 1
                        ...
                        local DisplayMethods = {
                            ...
                            Round = function(sliderValue, precision)
                                return precision and string.format("%." .. precision .. "f", sliderValue) or tostring(math.round(sliderValue))
                            end,
                            ...
                            Formatter = function(sliderValue)
                                if sliderValue >= 1e12 then
                                    return string.format("%.1fT", sliderValue / 1e12)
                                elseif sliderValue >= 1e9 then
                                    return string.format("%.1fB", sliderValue / 1e9)
                                elseif sliderValue >= 1e6 then
                                    return string.format("%.1fM", sliderValue / 1e6)
                                elseif sliderValue >= 1e3 then
                                    return string.format("%.1fK", sliderValue / 1e3)
                                else
                        ...
                        sliderValue.FocusLost:Connect(function(enterPressed)
                            local inputText = sliderValue.Text:upper()
                            local multiplier = 1
                            local value, unitOrPercent = inputText:match("^(%-?%d+%.?%d*)([KMBT%%]?)$")
                    
                            if value then
                                value = tonumber(value)
                    
                                if unitOrPercent == "%" then
                                    value = SliderFunctions.Settings.Minimum + (value / 100) * (SliderFunctions.Settings.Maximum - SliderFunctions.Settings.Minimum)
                                elseif unitOrPercent == "K" then
                                    multiplier = 1e3 
                                elseif unitOrPercent == "M" then
                                    multiplier = 1e6 
                                elseif unitOrPercent == "B" then
                                    multiplier = 1e9 
                                elseif unitOrPercent == "T" then
                                    multiplier = 1e12 
                                end
                    
                                local finalValue = value * multiplier
                                local clampedValue = math.clamp(finalValue, SliderFunctions.Settings.Minimum, SliderFunctions.Settings.Maximum)
                                SetValue(clampedValue, false) 
                                sliderValue.Text = ValueDisplayMethod(clampedValue, SliderFunctions.Settings.Precision)
                    
                                if SliderFunctions.Settings.onInputComplete then
                                    SliderFunctions.Settings.onInputComplete(clampedValue)
                                end
                            else
                                sliderValue.Text = ValueDisplayMethod(SliderFunctions.Value, SliderFunctions.Settings.Precision)
                            end
                        end)
                        ...
                        local function updateSliderBarSize()
                            ...
                            if newBarWidth < 80 then
                                sliderElementsUIListLayout.FillDirection = Enum.FillDirection.Vertical
                                sliderValue.LayoutOrder = 1
                    ...
                    function SectionFunctions:Input(Settings, Flag)
                        ...
                        input.Size = UDim2.new(1, 0, 0, 38 * scale)
                        ...
                        inputBox.Size = UDim2.fromOffset(21 * scale, 21 * scale)
                        ...
                        inputBoxUIPadding.PaddingLeft = UDim.new(0, 5 * scale)
                        inputBoxUIPadding.PaddingRight = UDim.new(0, 5 * scale)
                    ...
                    function SectionFunctions:Keybind(Settings, Flag)
                        ...
                        keybind.Size = UDim2.new(1, 0, 0, 38 * scale)
                        ...
                        keybindName.TextSize = 13 * scale
                        keybindName.TextTransparency = 0.5
                        keybindName.TextTruncate = Enum.TextTruncate.None
                        ...
                        binderBox.Size = UDim2.fromOffset(21 * scale, 21 * scale)
                        ...
                        binderBoxUIPadding.PaddingLeft = UDim.new(0, 5 * scale)
                        binderBoxUIPadding.PaddingRight = UDim.new(0, 5 * scale)
                        ...
                        UserInputService.InputBegan:Connect(function(inp)
                            if focused and not isBinding then
                                ...
                                -- here fix cuh
                                if not reset and not isTyping and (inp.KeyCode == binded or inp.UserInputType == binded) then
                        ...
                        UserInputService.InputEnded:Connect(function(inp)
                            if not focused and not isBinding and not isTyping then
                    ...
                    function SectionFunctions:Dropdown(Settings, Flag)
                        ...
                        dropdown.Size = UDim2.new(1, 0, 0, 38 * scale)
                        dropdown.Parent = section
                        dropdown.ClipsDescendants = true

                        local dropdownUIPadding = Instance.new("UIPadding")
                        dropdownUIPadding.Name = "DropdownUIPadding"
                        dropdownUIPadding.PaddingLeft = UDim.new(0, 15 * scale)
                        dropdownUIPadding.PaddingRight = UDim.new(0, 15 * scale)
                        ...
                        dropdownName.TextSize = 13 * scale
                        ...
                        dropdownName.Size = UDim2.new(1, -20 * scale, 0, 38 * scale)
                        ...
                        dropdownImage.Size = UDim2.fromOffset(14 * scale, 14 * scale)
                        ...
                        dropdownFrameUIPadding.PaddingTop = UDim.new(0, 38 * scale)
                        dropdownFrameUIPadding.PaddingBottom = UDim.new(0, 10 * scale)
                        ...
                        dropdownFrameUIListLayout.Padding = UDim.new(0, 5 * scale)
                        ...
                        local function addOption(i, v)
                            ...
                            option.BorderColor3 = Color3.fromRGB(0, 0, 0)
                            option.BorderSizePixel = 0
                            option.Size = UDim2.new(1, 0, 0, 30 * scale)
                        
                            local optionUIPadding = Instance.new("UIPadding")
                            optionUIPadding.Name = "OptionUIPadding"
                            optionUIPadding.PaddingLeft = UDim.new(0, 15 * scale)
                            optionUIPadding.Parent = option
                            ...
                            optionName.RichText = true
                            optionName.TextColor3 = Color3.fromRGB(255, 255, 255)
                            optionName.TextSize = 13 * scale
                            optionName.TextTransparency = 0.5
                            optionName.TextTruncate = Enum.TextTruncate.None
                        ...
                        function DropdownFunctions:Refresh(NewOptions)
                            local AlreadyOptions = DropdownFunctions:GetOptions()
                    ...
                    function SectionFunctions:Colorpicker(Settings, Flag)
                        ...
                        colorpicker.Size = UDim2.new(1, 0, 0, 38 * scale)
                        ...
                        colorpickerName.TextTruncate = Enum.TextTruncate.None
                        ...
                        colorCbg.Size = UDim2.fromOffset(21 * scale, 21 * scale)
                        ...
                        local uICorner = Instance.new("UICorner")
                        uICorner.Name = "UICorner"
                        uICorner.CornerRadius = UDim.new(0, 8 * scale)
                        ...
                        inputName1.TextTruncate = Enum.TextTruncate.None
                        inputName1.TextWrapped = true
                        ...
                        inputName2.TextTruncate = Enum.TextTruncate.None
                        inputName2.TextWrapped = true
                        ...
                        inputName3.TextTruncate = Enum.TextTruncate.None
                        inputName3.TextWrapped = true
                        ...
                        inputName4.TextTruncate = Enum.TextTruncate.None
                        inputName4.TextWrapped = true
                        ...
                        confirm.TextTruncate = Enum.TextTruncate.None
                        ...
                        cancel.TextTruncate = Enum.TextTruncate.None
                        ...
                        paragraphHeader.TextSize = 15 * scale
                    ...
                    function SectionFunctions:Label(Settings, Flag)
                        ...
                        label.Size = UDim2.new(1, 0, 0, 38 * scale)
                        ...
                        function LabelFunctions:Refresh(Fam)
                            labelText.Text = Fam
                        end
                    ...
                    function SectionFunctions:SubLabel(Settings, Flag)
                        ...
                        subLabelText.TextSize = 12 * scale
                    ...
                    function SectionFunctions:Paragraph(Settings, Flag)
                        ...
                        paragraphBody.TextSize = 13 * scale
                    ...
                    function SectionFunctions:Divider()
                        ...
                        divider.Size = UDim2.new(1, 0, 0, 1 * scale)
                        divider.Parent = section
                    
                        local uIPadding = Instance.new("UIPadding")
                        uIPadding.Name = "UIPadding"
                        uIPadding.PaddingBottom = UDim.new(0, 10 * scale)
                        uIPadding.PaddingTop = UDim.new(0, 10 * scale)
                    ...
                    function SectionFunctions:Spacer()
                        ...
                        spacer.Size = UDim2.new(1, 0, 0, 10 * scale)
        ...
        function WindowFunctions:Notify(Settings)
            ...
            notification.Size = UDim2.fromOffset((200) * scale, 0) -- Increased width
            ...
            notificationUICorner.CornerRadius = UDim.new(0, 8 * scale) -- Slightly increased corner radius
            ...
            notificationTitle.TextSize = 11 * scale -- Slightly increased text size
            ...
            notificationTitle.Size = UDim2.new(1, -8 * scale, 0, 0) -- Adjusted padding
        
            local notificationTitleUIPadding = Instance.new("UIPadding")
            notificationTitleUIPadding.Name = "NotificationTitleUIPadding"
            notificationTitleUIPadding.PaddingRight = UDim.new(0, 20 * scale) -- Slightly increased padding
            ...
            notificationDescription.TextSize = 10 * scale -- Slightly increased text size
            ...
            notificationDescription.Size = UDim2.new(1, -8 * scale, 0, 0)
            ...
            notificationDescriptionUIPadding.PaddingRight = UDim.new(0, 20 * scale) -- Slightly increased padding
            notificationDescriptionUIPadding.PaddingTop = UDim.new(0, 12 * scale) -- Adjusted padding
            ...
            notificationUIPadding.PaddingBottom = UDim.new(0, 10 * scale) -- Slightly increased padding
            notificationUIPadding.PaddingLeft = UDim.new(0, 8 * scale) -- Slightly increased padding
            notificationUIPadding.PaddingRight = UDim.new(0, 8 * scale) -- Slightly increased padding
            notificationUIPadding.PaddingTop = UDim.new(0, 8 * scale) -- Slightly increased padding
            ...
            interactable.TextSize = 12 * scale -- Slightly increased text size
            ...
            local uIPadding = Instance.new("UIPadding")
            uIPadding.Name = "UIPadding"
            uIPadding.PaddingBottom = UDim.new(0, 6 * scale) -- Slightly increased padding
            uIPadding.PaddingRight = UDim.new(0, 10 * scale) -- Slightly increased padding
            uIPadding.PaddingTop = UDim.new(0, 6 * scale) -- Slightly increased padding
            ...
            function NotificationFunctions:Resize(X)
                local targ = X or 200 -- Slightly larger width
                notification.Size = UDim2.fromOffset(targ * scale, 0)
            end
        ...
        local MenuKeybind = KeybindBruh or Settings.Keybind or Enum.KeyCode.RightControl
            ...
            ["Keybind"] = {
                Save = function(Flag, data)
                    return {
                        type = "Keybind",
                        flag = Flag,
                        bind = (data.GetBind and data:GetBind() and data:GetBind().Name) or nil 
                    }
                end,
                Load = function(Flag, data)
                    if MacLib.Options[Flag] and data.bind then
                        local keyEnum = Enum.KeyCode[data.bind] or Enum.UserInputType[data.bind]
                        if keyEnum then
                            MacLib.Options[Flag]:Bind(keyEnum) 
                        end
                    end
                end
            },            
            ["Dropdown"] = {
                Save = function(Flag, data)
                    return {
                        type = "Dropdown",
                        flag = Flag,
                        value = data.Multi and data.Values or data.Value
                    }
                end,
                Load = function(Flag, data)
    ...
    function MacLib:Demo()
        local Window = MacLib:Window({
            ...
            ShowUserInfo = true,
            Keybind = Enum.KeyCode[HideButton] or Enum.KeyCode.RightControl,
            AcrylicBlur = true,
        })
